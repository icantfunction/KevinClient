...
export default function PhotographyHome() {
  return (
    <MotionConfig reducedMotion="user">
      <div className="wwe-shell min-h-screen" id="top">
        ...
        <main>
          ...
          <section className="section contact" id="contact">
            ...
            >
              ...
              <p>
                Share your date, destination, and vision. We will respond
                within 48 hours with a tailored proposal and editorial timeline
                guide.
              </p>
